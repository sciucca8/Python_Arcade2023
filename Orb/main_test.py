...
class MainMenuView(arcade.View):
    def __init__(self, gameview_reference):
        ...
        button_score.on_click = self.go_play_score
...
class GameOverView(arcade.View):
    def __init__(self, score):
        super().__init__()
              ...
              # The instance of GameView used to go back to the game screen.
...
class GameView(arcade.View):                   # Child class for the game of the parent class View.
    def __init__(self, level_mode_time=None, level_mode_obstacles=None, level_mode_score=None):    # Set the parameters for the new class. 
